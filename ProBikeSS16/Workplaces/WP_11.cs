namespace ProBikeSS16.Workplaces
{
    class WP_11 : Workplace
    {
        ...
        public void produce_one_bath_E4()
        {
            ...
            currentWorkTime += getApproxProdTimeE4(prod_batch);
            onMachine = 0;
        }
        #endregion
        ...
        public void produce_one_bath_E5()
        {
            ...
            currentWorkTime += getApproxProdTimeE5(prod_batch);
            onMachine = 0;
        }
        #endregion
        ...
        public void produce_one_bath_E6()
        {
            ...
            currentWorkTime += getApproxProdTimeE6(prod_batch);
            onMachine = 0;
        }
        #endregion
        ...
        public void produce_one_bath_E7()
        {
            ...
            currentWorkTime += getApproxProdTimeE7(prod_batch);
            onMachine = 0;
        }
        #endregion
        ...
        public void produce_one_bath_E8()
        {
            ...
            currentWorkTime += getApproxProdTimeE8(prod_batch);
            onMachine = 0;
        }
        #endregion
        ...
        public void produce_one_bath_E9()
        {
            ...
            currentWorkTime += getApproxProdTimeE9(prod_batch);
            onMachine = 0;
        }
        #endregion
